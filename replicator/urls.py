...
urlpatterns = [
	...
	path("delete_replication/<int:pk>", views.ReplicationDeleteView.as_view(), name = "delete_replication"),
	...
	path("edit_settings/<int:pk>", views.SettingsEditView.as_view(), name = "edit_settings"),
]
